...
        <% if (request.getAttribute("chatResult") != null) { %>
            <p style="color: green; font-weight: bold;"><%= request.getAttribute("chatResult") %></p>
        <% } %>
        ...
        <div class="card full-width ai-interface-card">
            ...
            <form method="post" action="<%=request.getContextPath() %>/BoyaCatchAction">
                <textarea id="user-input" name="input" rows="3" placeholder="AIとの対話内容を入力してください..."></textarea>
